...
\begin{figure}[h]
    ...
    \caption{Visual representation of the trial construction. The target and interferer are drawn from LibriSpeech, and the noise bed is drawn from WHAM!. The mixture is constructed by adding the three components together, and the enrollment clip is drawn from the same source as the target speech.}
