...
\label{sec:nrr}
The Non-Response Rate (NRR) is a metric specifically meant for the fact that live speech-to-text models are prompted, and thus respond in a way that is not necessarily a transcription of the audio. 
