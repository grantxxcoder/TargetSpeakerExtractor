...
\begin{table}[htbp]
\centering
\caption{Signal-domain decomposition, in \si{\decibel}; higher is better. The ceiling reaches \SI{+30}{\decibel} by construction, being the cap imposed by the denominator floor $\tau = 10^{-3}$, and is not a measurement.}
\label{tab:signal}
\begin{tabular}{@{}lccc@{}}
\toprule
system & SDR & SIR & SAR \\
...
\begin{table}[htbp]
\centering
\caption{Latency and throughput, measured over 2{,}250 chunks of \SI{80}{\milli\second} on CPU (i5-1135G7, 4 threads). The requirement is $\textup{RTF} < 1$ and latency within \SI{200}{}--\SI{300}{\milli\second}.}
\label{tab:latency}
\small
\begin{tabular}{@{}lccccc@{}}
\toprule
