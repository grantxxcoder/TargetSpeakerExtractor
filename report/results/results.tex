...
\begin{table}[htbp]
\centering
\caption{Content recovered Gemini Live. \texttt{gemini-3.7-flash}, audio in
/ text out}
...
Extension (mask structure) & 55.36 & 65.05 & 47.98 & 2.28 & 48.04 \\
...
\begin{tabular}{@{}lccccc@{}}
\toprule
 & WER & ICR@2 & mean leak & invented & FR@2 \\
system & (\%) & (\%) & (\%) & /trial & (\%) \\
\midrule
Floor (do nothing)    & 65.22 & 66.99 & 51.30 & 2.61 & 57.28 \\
Ours (4{,}976 trials) & 59.05 & 54.37 & 39.13 & \textbf{2.73} & \textbf{60.61} \\
Ours (9{,}955 trials) & 59.52 & 50.49 & 34.58 & 3.08 & 68.00 \\
Extension (mask structure) & 56.58 & 49.51 & 31.63 & 3.45 & 70.59 \\
...
\midrule
Ours (4{,}976) & Gemini Live & 10.5 & 17.9 & 20.8 \\
Ours (9{,}955) & Gemini Live & 12.3 & 19.2 & 23.7 \\
WeSep          & Gemini Live & \textbf{59.3} & \textbf{66.7} & \textbf{79.6} \\
\midrule
Ours (4{,}976) & ASR   & 10.4 & 18.8 & 23.7 \\
Ours (9{,}955) & ASR   & 9.6  & 24.6 & 32.6 \\
WeSep          & ASR   & \textbf{51.6} & \textbf{76.8} & \textbf{82.4} \\
\bottomrule
\end{tabular}
...
Extension (mask structure) & 22.18 & 5.09 & 28.08 & 27.27 & 8.76 & 20.55 \\
...
Extension (mask structure) & $+2.29$ & $+5.33$ & $+9.96$ \\
...
Extension (mask structure) & 2.996 & 3.375 & 2.498 & 2.347 \\
...
\midrule
Ours (4{,}976 trials)$^\dagger$ & \textbf{0.528} & \textbf{0.706} & \textbf{162.2} & \textbf{176.5} & yes$^\dagger$ \\
Ours (9{,}955 trials)      & 0.783 & 1.095 & 182.6 & 207.6 & mean only \\
Extension (gate)           & --- & --- & --- & --- & --- \\
Extension (mask structure) & 0.839 & 1.278 & 187.1 & 222.2 & mean only \\
