...
| 2026-09-24 | `scripts/eval_by_case.py --split sir0_val --cases target_only,both,interferer_only,noise_only --listener asr` | 4 cases, sir0_val, listener asr | 5 min |  |
| 2026-09-24 | `scripts/evaluate.py` | --split sir0_val --condition both --est /home/grant/Documents/University/Masters/Project/TargetSpeakerExtractor/experiments/results/2026-09-24-est-cuecontext-wer-e13 --metrics content --out /home/grant/Documents/University/Masters/Project/TargetSpeakerExtractor/experiments/results/2026-09-24-eval-cuecontext-wer-e13-asr | 6 min |  |
| 2026-09-24 | `scripts/make_estimates.py` | 200 trials rendered, sir0 | 30 min | cpu, whole-clip |
| 2026-09-24 | `scripts/train.py --split sir0` | 9,955 trials x 14 epochs (no early stop, best idx 13 = last), sir0 | 11.2 h | batch 3, cuda (T4), **2,886 s/epoch**. Item 1c + `content_wer` selection: the 40-clip cpu ASR probe costs ~300 s/epoch (2,575 without). 47 min under the 12 h cap. Copied by hand from meta.yaml |
| 2026-09-23 | `scripts/measure_rtf.py` | --checkpoint models/model_sir0_cuecontext-e5.pt --config experiments/configs/bsrnn_cue_context.yaml --chunk-ms 80 --threads 4 --device cpu --out /home/grant/Documents/University/Masters/Project/TargetSpeakerExtractor/experiments/results/2026-09-23-rtf-cuecontext-e5 | 2 min |  |
| 2026-09-23 | `scripts/measure_rtf.py` | --checkpoint models/model_sir0_cuecontext-e12.pt --config experiments/configs/bsrnn_cue_context.yaml --chunk-ms 80 --threads 4 --device cpu --out /home/grant/Documents/University/Masters/Project/TargetSpeakerExtractor/experiments/results/2026-09-23-rtf-cuecontext-e12 | 2 min |  |
| 2026-09-23 | `scripts/evaluate.py` | --split sir0_privval --condition both --est experiments/results/2026-09-23-est-privval-cueparts-e15 --metrics content --out experiments/results/2026-09-23-eval-privval-cueparts-e15-asr | 2.0 h |  |
| 2026-09-23 | `scripts/evaluate.py` | --split sir0_val --condition both --est /home/grant/Documents/University/Masters/Project/TargetSpeakerExtractor/experiments/results/2026-09-23-est-cuecontext-e5 --metrics signal,perceptual --out /home/grant/Documents/University/Masters/Project/TargetSpeakerExtractor/experiments/results/2026-09-23-eval-cuecontext-e5-signal | 29 min |  |
| 2026-09-23 | `scripts/evaluate.py` | --split sir0_val --condition both --est /home/grant/Documents/University/Masters/Project/TargetSpeakerExtractor/experiments/results/2026-09-23-est-cuecontext-e12 --metrics signal,perceptual --out /home/grant/Documents/University/Masters/Project/TargetSpeakerExtractor/experiments/results/2026-09-23-eval-cuecontext-e12-signal | 24 min |  |
| 2026-09-23 | `scripts/make_estimates.py` | 1421 trials rendered, sir0ext | 8.7 h | cpu, whole-clip. **NOT a render-speed number:** includes 2.7 h PAUSED (SIGSTOP 16:33-19:15) and ~4 h sharing the CPU with two other sessions' renders. Uncontended 19:15-21:14 ran ~9-10 s/trial |
| 2026-09-23 | `scripts/eval_by_case.py --split sir0_val --cases target_only,both,interferer_only,noise_only --listener asr` | 4 cases, sir0_val, listener asr | 10 min |  |
| 2026-09-23 | `scripts/make_estimates.py` | 200 trials rendered, sir0 | 1.7 h | cpu, whole-clip |
| 2026-09-23 | `scripts/evaluate.py` | --split sir0_val --condition both --est /home/grant/Documents/University/Masters/Project/TargetSpeakerExtractor/experiments/results/2026-09-23-est-cuecontext-e5 --metrics content --listener judge --judge-rpm 10 --out /home/grant/Documents/University/Masters/Project/TargetSpeakerExtractor/experiments/results/2026-09-23-eval-cuecontext-e5-judge | 15 min |  |
| 2026-09-23 | `scripts/diagnose_cue_directional.py` | 200 trials x 2 directions, sir0 | 16 min | cpu, batch 4 trials |
| 2026-09-23 | `scripts/evaluate.py` | --split sir0_val --condition both --est /home/grant/Documents/University/Masters/Project/TargetSpeakerExtractor/experiments/results/2026-09-23-est-cuecontext-e12 --metrics content --listener judge --judge-rpm 10 --out /home/grant/Documents/University/Masters/Project/TargetSpeakerExtractor/experiments/results/2026-09-23-eval-cuecontext-e12-judge | 15 min |  |
| 2026-09-23 | `scripts/eval_by_case.py --split sir0_val --cases target_only,both,interferer_only,noise_only --listener asr` | 4 cases, sir0_val, listener asr | 8 min |  |
| 2026-09-23 | `scripts/evaluate.py` | --split sir0_val --condition both --est /home/grant/Documents/University/Masters/Project/TargetSpeakerExtractor/experiments/results/2026-09-23-est-cuecontext-e5 --metrics content --out /home/grant/Documents/University/Masters/Project/TargetSpeakerExtractor/experiments/results/2026-09-23-eval-cuecontext-e5-asr | 11 min |  |
| 2026-09-23 | `scripts/evaluate.py` | --split sir0_val --condition both --est experiments/results/2026-09-23-est-cuecontext-e12 --metrics content --out experiments/results/2026-09-23-eval-cuecontext-e12-asr | 21 min |  |
| 2026-09-23 | `scripts/make_estimates.py` | 200 trials rendered, sir0 | 2.1 h | cpu, whole-clip |
| 2026-09-23 | `scripts/make_estimates.py` | 103 trials rendered, sir0 | 1.3 h | cpu, whole-clip |
| 2026-09-23 | `scripts/diagnose_cue_directional.py` | 200 trials x 2 directions, sir0 | 35 min | cpu, batch 4 trials |
| 2026-09-23 | `scripts/diagnose_cue_directional.py` | 200 trials x 2 directions, sir0 | 36 min | cpu, batch 4 trials |
| 2026-09-23 | `scripts/eval_by_case.py --split sir0_val --cases target_only --listener judge` | 1 cases, sir0_val, listener judge | 6 min |  |
| 2026-09-23 | `scripts/eval_by_case.py --split sir0_val --cases target_only --listener judge` | 1 cases, sir0_val, listener judge | 17 min |  |
| 2026-09-23 | `scripts/evaluate.py` | --split sir0_val --condition both --est /home/grant/Documents/University/Masters/Project/TargetSpeakerExtractor/experiments/results/2026-09-23-est-cueparts-e15 --metrics content --listener judge --judge-rpm 10 --out /home/grant/Documents/University/Masters/Project/TargetSpeakerExtractor/experiments/results/2026-09-23-eval-cueparts-e15-judge | 14 min |  |
| 2026-09-23 | `scripts/eval_by_case.py --split sir0_val --cases target_only,both,interferer_only,noise_only --listener asr` | 4 cases, sir0_val, listener asr | 6 min |  |
| 2026-09-23 | `scripts/evaluate.py` | --split sir0_val --condition both --est /home/grant/Documents/University/Masters/Project/TargetSpeakerExtractor/experiments/results/2026-09-23-est-cueparts-e15 --metrics content --out /home/grant/Documents/University/Masters/Project/TargetSpeakerExtractor/experiments/results/2026-09-23-eval-cueparts-e15-asr | 7 min |  |
| 2026-09-23 | `scripts/make_estimates.py` | 200 trials rendered, sir0 | 31 min | cpu, whole-clip |
| 2026-09-23 | `scripts/measure_rtf.py` | --checkpoint models/model_sir0_cueparts-e9.pt --config experiments/configs/bsrnn_cue_parts.yaml --chunk-ms 80 --threads 4 --device cpu --out /home/grant/Documents/University/Masters/Project/TargetSpeakerExtractor/experiments/results/2026-09-23-rtf-cueparts-e9 | 3 min |  |
| 2026-09-23 | `scripts/evaluate.py` | --split sir0_val --condition both --est /home/grant/Documents/University/Masters/Project/TargetSpeakerExtractor/experiments/results/2026-09-23-est-cueparts-e9 --metrics signal,perceptual --out /home/grant/Documents/University/Masters/Project/TargetSpeakerExtractor/experiments/results/2026-09-23-eval-cueparts-e9-signal | 17 min |  |
| 2026-09-23 | `scripts/eval_by_case.py --split sir0_val --cases target_only,both,interferer_only,noise_only --listener asr` | 4 cases, sir0_val, listener asr | 7 min |  |
| 2026-09-23 | `scripts/evaluate.py` | --split sir0_val --condition both --est /home/grant/Documents/University/Masters/Project/TargetSpeakerExtractor/experiments/results/2026-09-23-est-cueparts-e9 --metrics content --out /home/grant/Documents/University/Masters/Project/TargetSpeakerExtractor/experiments/results/2026-09-23-eval-cueparts-e9-asr | 8 min |  |
| 2026-09-23 | `scripts/make_estimates.py` | 200 trials rendered, sir0 | 43 min | cpu, whole-clip |
| 2026-09-23 | `scripts/diagnose_cue_directional.py` | 200 trials x 2 directions, sir0 | 25 min | cpu, batch 4 trials. CONTENDED: ran beside make_estimates.py from another session, so not comparable to the 10-16 min rows |
| 2026-09-23 | `scripts/train.py --split sir0` | 9,955 trials x 13 epochs (no early stop, best idx 5), sir0 | 9.3 h | batch 3, cuda (T4), **2,575 s/epoch**. Item 1c, `bsrnn_cue_context.yaml`: ECAPA runs on every batch, +9.3 % on 1a's 2,356 (cross-session). Copied by hand from the pasted log |
| 2026-09-23 | `scripts/train.py --split sir0` | 9,955 trials x 16 epochs (no early stop, best idx 9), sir0 | 10.5 h | batch 3, cuda (T4), **2,356 s/epoch**. Item 1a, `bsrnn_cue_parts.yaml`, `log_struct` on. Same as the 09-04 control's 2,364: the probe's +5.2 % was session variance. Copied by hand from meta.yaml |
