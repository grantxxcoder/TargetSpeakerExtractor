...
**Every other decision is made** and recorded in `docs/decisions/decisions.md`. Group A
...
### A5. *Decided 2026-08-13 — yes, pad by `t60_s`. See `decisions.md`.*

### A6. *Decided 2026-08-13 — common-gain rescale at 0.95. See `decisions.md`.*
...
### B2. *Decided 2026-08-13 — measure from detected speech. See `decisions.md`.*

Detector to be named in the PR that adds it.

### B3. *Decided 2026-08-12 — fixed 5 s, kept configurable. See `decisions.md`.*

### B4. *Decided 2026-08-13 — yes, same fraction as train, scored on their own row. See `decisions.md`.*

The fraction itself follows B9.

### B5. *Decided 2026-08-13 — Whisper `EnglishTextNormalizer`. See `decisions.md`.*

### B6. *Decided 2026-08-13 — 500 generated, 200 the minimum scored. See `decisions.md`.*

### B7. *Decided 2026-08-13 — off for the main run, kept as a switch. See `decisions.md`.*

### B8. *Decided 2026-08-11 — different book. See `decisions.md`.*

### B9. *Decided 2026-08-13 — 50 % both / 25 % absent / 25 % target-only, and a variable target activity ratio. See `decisions.md`.*

Blocks the manifest rebuild until implemented. Sets B4's eval fraction at 0.25.

### B10. *Decided 2026-08-13 — three enrollment tiers, recorded per trial; eval pools redrawn. See `decisions.md`.*

Not a reversal of B8: B8's cost note specified this fallback and its trigger. Folds
into the PR3 rebuild.

### B11. *Decided 2026-08-13 — report a latency decay curve, never cap T60. See `decisions.md`.*
...
### B13. *Decided 2026-08-13 — per condition, no combinations, 100 trials per bucket. See `decisions.md`.*
...
4. *B4 — answered 2026-08-12 and now fully decided. See `decisions.md`.*
5. *B11 — decided 2026-08-13, and largely defused by A1. See `decisions.md`.*
